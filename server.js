...
var MONGODB_URI = "mongodb://localhost/week18ScrappingHw";
...
// Route for grabbing a specific blog by id, populate it with it's note
app.get("/blogs/:id", function(req, res) {
    ...
    // Route for saving/updating a blog's associated Note
app.post("/blogs/:id", function(req, res) {
  ...
  // Route for deleting/updating a blog's associated Note
